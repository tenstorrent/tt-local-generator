...
#   tt-inference-server/workflow_logs/docker_server/media_<timestamp>_Wan2.2-T2V-A14B-Diffusers_p300x2_server.log
# This script waits for that file to appear then tails it live.
#
# Usage:
#   ./start_wan_qb2.sh            # start server and tail its log
#   ./start_wan_qb2.sh --stop     # stop the running server container
#   ./start_wan_qb2.sh --gui      # start without interactive prompts or tail (for GUI use)
#   ./start_wan_qb2.sh --help     # show this help
...
echo "Starting Wan2.2-T2V-A14B-Diffusers on P300x2 (QB2)…"
echo "  Repo:      $REPO_DIR"
